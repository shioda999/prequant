...
@torch.no_grad()
def stat_act(model, tokenizer, dataset=None, num_samples=10, seq_len=None, min_v=None, max_v=None, calc_H=True):
    ...
    def stat_tensor(name, tensor):
        ...
        if calc_H: H = (tensor.transpose(-1, -2) @ tensor).sum(dim=0)
